...
public class ProductCatalogue extends AbstractComponents {
	...
	public WebElement getProductByElement(String productName) {
		WebElement prod = products.stream()
				          .filter(product -> product.findElement(By.cssSelector("b")).getText().equals(productName)).findFirst().orElse(null);
		return prod;
	}
	
	public void addPoductToCart(String productName) throws InterruptedException {
		WebElement prod = getProductByElement(productName);
